...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterSort:{
			mobile:{
				mobile_default:["miheng","taoqian","lingcao","sunru","lifeng","zhuling","liuye","zhaotongzhaoguang","majun","simazhao","wangyuanji",
								...
								"yangfu","wangjun","sp_pengyang","qianzhao","old_wanglang",'shichangshi','mb_guozhao','mb_laimin','mb_liwei','mb_xianglang'],
				mobile_yijiang:["yj_zhanghe","yj_zhangliao","yj_xuhuang","yj_ganning",'yj_huangzhong','yj_weiyan','mbyj_zhoubuyi'],
				mobile_standard:["xin_xiahoudun","xin_zhangfei"],
				mobile_shenhua:["re_pangtong","re_guanqiujian","xin_yuanshao","re_liushan","re_dongzhuo","re_sp_zhugeliang","re_sunjian","re_dengai","re_jiangwei","re_zhurong","re_caiwenji","re_xunyu","re_dianwei","xin_zhoutai","re_yanwen",'re_zhangzhang',"re_sunben"],
		...
		character:{
			...
			mbyj_zhoubuyi:['male','wei',3,['mbhuiyao','mbquesong']],
		...
		skill:{
			...
			mbjiaohua:{
				...
				content:function(){
					...
					player.chooseControl(list,true).set('prompt','教化：令'+get.translation(target)+'从牌堆中获得一张该类型的牌');
					'step 1'
					var map={
						'基本牌':'basic',
						'锦囊牌':'trick',
			...
			mbquesong:{
				...
				content:function(){
					...
					if(result.bool){
						...
						var list=[['draw','摸等同于其装备区中空栏的数量-1的牌并复原武将牌']];
					...
					'step 3'
					event.target.draw(4-event.target.countDisabled()-event.target.countCards('e'));
					'step 4'
			...
			jueyong:{
				...
				filter:function(event,player){
					return event.card.name!='jiu'&&event.card.name!='tao'&&
						...
						(!player.storage.jueyong||player.storage.jueyong[0].length<player.hp);
				},
				content:function(){
		...
		translate:{
			...
			mbquesong:'雀颂',
			mbquesong_info:'一名角色的结束阶段，若你于本回合受到过伤害，你可以令一名角色选择一项：1.摸等同于其装备区中空栏的数量-1的牌并复原武将牌；2.弃置等同于其体力值的手牌并回复1点体力。',
			mb_laimin:'来敏',
			mblaishou:'来寿',
