...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			re_wangyi:['female','wei',3,['zhenlie','miji']],
		...
		skill:{
			...
			rejiushi_mark:{
				...
				marktext:'改',
				intro:{
					content:'当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】并回复一点体力若体力已满则摸一张牌。当你受到伤害后，若你的武将牌背面向上，你可以翻面。当你翻面时，你获得牌堆中的一张随机锦囊。',
				},
			},
			rehongyan:{
				audio:2,
		...
		translate:{
			...
			rejiushi:'酒诗',
			rejiushi_info:'当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】并回复一点体力若体力已满改为摸一张牌。当你受到伤害后，若你的武将牌背面向上，你可以翻面并获得牌堆中的一张随机锦囊。',
			rejiushi1:'酒诗',
			rejiushi3:'酒诗',
			rejiushi_mark:'酒诗·改',
			rejiushi_mark_info:'当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】并回复一点体力若体力已满改为摸一张牌。当你受到伤害后，若你的武将牌背面向上，你可以翻面。当你翻面时，你获得牌堆中的一张随机锦囊。',
			chengzhang:'成章',
